    ...
    <>
      ...
      {investmentpackage.duration == 7 ? (
        ...
        <div class="top-price-inner">
            <h3>{investmentpackage.name}</h3>
            <div class="rates">
            <span class="prices">{investmentpackage.percentage_interest}%</span><span class="users">
            {investmentpackage.duration == 7 ? (
                <span className="users">Weekly</span>
              ) : (
                <span className="users">Monthly</span>
        ...
        <ol class="pricing-text">
            <li class="check">Minimam Invest : ${investmentpackage.minimum_amount}</li>
            <li class="check">Maximam Invest : ${investmentpackage.maximum_amount}</li>
          {investmentpackage.duration == 7 ? (
            <li className="check">
              Total Monthly: {investmentpackage.percentage_interest * 4}%
            </li>
